"""Menu for name and addresses with file loading and saving"""
...
def main():
    ...
    # file = open("name_address_v2.txt", 'w')
    # for name in address_dict:
    #     file.write(f"{name}: {address_dict[name]}\n")
    # file.close()
    address_dict = {}
    file = open("name_address_v2.txt", 'r')
    for line in file:
        line = line.strip()
